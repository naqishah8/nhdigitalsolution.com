...
const testimonials = [
  ...
  },
  {
    ...
    content: 'Members use the app daily for workout streaks and class bookings. IG went from 1.2k to 14k in 8 months. Real ROI, not vanity metrics.',
    rating: 4.5,
  ...
  },
  {
    ...
    content: 'Replaced our agency after a disappointing year. NH rebuilt the marketing site in 5 weeks. Lighthouse jumped from 52 to 98 and qualified leads doubled in Q2.',
    rating: 5,
